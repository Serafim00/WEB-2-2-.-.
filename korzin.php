...
<form method="post" action="index1.php.php?page=cart">
  ...
  <div class="in-check" >
      ...
      </li><li><span><input type="text" name="quantity[<?php echo $row['id_product'] ?>]" size="5" value="<?php echo $_SESSION['cart'][$row['id_product']]['quantity'] ?>" /></span></li>

      </li><li><span><?php echo $_SESSION['cart'][$row['id_product']]['quantity']*$row['price'] ?>P</span></li>
